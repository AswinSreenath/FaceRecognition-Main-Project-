...
{
    public partial class Trainingimages : Form
    {
        #region Variables
        //Camera specific
        Capture grabber;
        ...
        Form3 Parent;
        #endregion
        public Trainingimages(Form3 _Parent)
        {
            InitializeComponent();
            Parent = _Parent;
            Face = Parent.Face;
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            // filepath = openFileDialog1.FileName;
            // Image img = Image.FromFile(filepath);
            Image InputImg = Image.FromFile(filepath);   //1-
            Image<Bgr, byte> EmguImage = new Image<Bgr, byte>(new Bitmap(InputImg)); //2-
            // Image<Bgr, Byte> firstImage = new Image<Bgr, byte>(Application.StartupPath+"lkk.jpg");
        ...
        private void Trainingimages_Load(object sender, EventArgs e)
        {
            panel2.Visible = false;
        }
    }
